...
Duck.create!(name: "Bol", description: "He's smol, looks like a golf bol, dont rent it together with golfing duck ", picture_url: "golf_ball_duck.jpg", price_per_day: 9.0, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Erwan", description: "To impress your friends at the country club.", picture_url: "golfing_duck.jpg", price_per_day: 2.5, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Sonya", description: "Can sing in 56 different language, dont put it too close to the campfire.", picture_url: "guitar_duck.jpg", price_per_day: 3.5, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Joey", description: "Dont tell Charly this one exist, he forget the concept of hairdressing when he got covid.", picture_url: "hairdresser_duck.jpg", price_per_day: 5.0, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
