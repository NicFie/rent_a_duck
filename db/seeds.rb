...
Duck.create!(name: "Donald", description: "Yellow duck wow", picture_url: "biff_duck.png", price_per_day: 5.0, user: user, address: "6 rue desaugiers Lyon", latitude: 45.744270, longitude: 4.833710)
