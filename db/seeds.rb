...
Duck.create!(name: "Alan Grant", description: "Smart, resilient, likes children and toasts, for sure will not accept to endorse your park.", picture_url: "alan_grant_duck.jpg", price_per_day: 5.0, user: user, address: "Attica, Plymouth Street, Swansea", latitude: 51.619028, longitude: -3.947579)
...
Duck.create!(name: "Augustus", description: "For the empire ! And as he likes to say: In vino veritas !", picture_url: "augustus_duck.jpg", price_per_day: 9.0, user: user, address: "Attica, Plymouth Street, Swansea", latitude: 51.619028, longitude: -3.947579)
...
Duck.create!(name: "Bruce", description: "Kinda moody, likes to hang alone in the dark. ", picture_url: "batman_duck.jpg", price_per_day: 5.0, user: user, address: "Attica, Plymouth Street, Swansea", latitude: 51.619028, longitude: -3.947579)
...
Duck.create!(name: "Biff", description: "Will help you fight off those brutes you're terrified about.", picture_url: "bully_duck.jpg", price_per_day: 5.0, user: user, address: "Attica, Plymouth Street, Swansea", latitude: 51.619028, longitude: -3.947579)
...
Duck.create!(name: "Primavera", description: "Always happy, will cheer you up in any situation.", picture_url: "hippy_duck.png", price_per_day: 3.5, user: user, address: "The Mall, London", latitude: 51.503104, longitude: -0.138606)
Duck.create!(name: "Boud Boud", description: "A great partner to start your journey to mental peace.", picture_url: "bouddha_duck.jpg", price_per_day: 5.0, user: user, address: "The Mall, London", latitude: 51.503104, longitude: -0.138606)
...
Duck.create!(name: "Bob", description: "Great for building friendship, building relashionship, building.. anything.", picture_url: "builder_duck.jpg", price_per_day: 5.0, user: user, address: "The Mall, London", latitude: 51.503104, longitude: -0.138606)
Duck.create!(name: "Sharky", description: "Even if you lost everything in cryptos he will tell you to buy more. Because he is selling.", picture_url: "business_duck.jpg", price_per_day: 7.0, user: user, address: "The Mall, London", latitude: 51.503104, longitude: -0.138606)
...
Duck.create!(name: "Marc", description: "Will talk to you when you cant answer, only then.", picture_url: "dentist_duck.jpg", price_per_day: 7.0, user: user, address: "Drumcullan Road, Downpatrick, BT30 8HY, Royaume-Uni", latitude: 54.3151745261252, longitude: -5.75918756281256)
...
Duck.create!(name: "Geordi", description: "Cant beam you up, but can look cool with those totally unpractical glasses.", picture_url: "geordi_star_trek_duck.jpg", price_per_day: 9.0, user: user, address: "Drumcullan Road, Downpatrick, BT30 8HY, Royaume-Uni", latitude: 54.3151745261252, longitude: -5.75918756281256)
Duck.create!(name: "Bill", description: "If there is something strange, in the neighbourhood. You won't have to call..", picture_url: "ghostbuster_duck.jpg", price_per_day: 2.5, user: user, address: "Drumcullan Road, Downpatrick, BT30 8HY, Royaume-Uni", latitude: 54.3151745261252, longitude: -5.75918756281256)
...
Duck.create!(name: "Bol", description: "He's smol, looks like a golf bol, dont rent it together with Erwan. ", picture_url: "golf_ball_duck.jpg", price_per_day: 9.0, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Erwan", description: "To impress your friends at the country club. Actively looking for Bol..", picture_url: "golfing_duck.jpg", price_per_day: 2.5, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Sonya", description: "Can sing in 56 different languages, dont put her too close to the campfire.", picture_url: "guitar_duck.jpg", price_per_day: 3.5, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
Duck.create!(name: "Joey", description: "Dont tell Charly this one exists, he forgot the concept of hairdressing when he got covid.", picture_url: "hairdresser_duck.jpg", price_per_day: 5.0, user: user, address: "Route de Sivry, 54610 Belleau, France", latitude: 48.82743645256504, longitude: 6.187593494395434)
